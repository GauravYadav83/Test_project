...
class Categories extends Component{
    ...
    componentDidMount = () =>{
        ...
        axios.get(`http://localhost:3000/events/?q=`+this.props.match.params.phrase).then((result)=>{
    ...
    render(){
        return(<div>
            ...
            {this.state.events.length>0?    <div><table className="table">
                ...
                <button type="submit" className="btn btn-primary" onClick={()=> this.props.history.push("/dashboard")}>Go Back</button>
                </div>:
